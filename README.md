...
<h2>Utilisation de l'API avec le front</h2>
<p>Le dossier front est une ébauche du futur site de gestion des apprenants de la ItAkademy, accéder au index HTML pour pouvoir gérer les étudiant pour l'instant vous pouvez voir la liste de tout les appprenants, chercher un apprenant avec son id et créer un apprenant</p> 
